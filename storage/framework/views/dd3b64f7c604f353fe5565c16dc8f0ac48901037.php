...
<div class="card">
	...
	<h5 class=" mb-0 text-gray-800 pl-3"><?php echo e(__('Loans')); ?></h5>
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
           ...
           serverSide: true,
           searching: true,
           ajax: '<?php echo e(route('admin.loan.datatables',['status'=>'all'])); ?>',
           columns: [
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\mamp\htdocs\geniusbank\project\resources\views/admin/loan/index.blade.php ENDPATH**/ ?>