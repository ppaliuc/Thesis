    ...
    <div class="container-xl">
      ...
      <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
        <a href="<?php echo e(route('front.index')); ?>">
          <img src="<?php echo e(asset('assets/images/'.$gs->logo)); ?>" width="110" height="32" alt="Tabler" class="navbar-brand-image">
        </a>
      </h1>
      <div class="navbar-nav flex-row order-md-last">
        ...
        <div class="nav-item dropdown">
          <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
            <span class="avatar avatar-sm" style="background-image: url(<?php echo e(auth()->user()->photo ? asset('assets/images/'.auth()->user()->photo) : asset('assets/user/img/user.jpg')); ?>)"></span>
          ...
          <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
            ...
            <a href="<?php echo e(route('user.change.password.form')); ?>" class="dropdown-item"><?php echo e(__('Change Password')); ?></a>
            <a href="<?php echo e(route('user.logout')); ?>" class="dropdown-item"><?php echo e(__('Logout')); ?></a>
          </div>
        </div>
      </div>
    </div>
  </header><?php /**PATH /home/royalscripts/public_html/test/geniusbank/project/resources/views/includes/user/header.blade.php ENDPATH**/ ?>