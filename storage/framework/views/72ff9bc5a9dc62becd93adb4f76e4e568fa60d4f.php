    ...
    <div class="container-xl">
      <div class="row mb--25-none">
          <?php if(count($plans) == 0): ?>
              <div class="card">
                  <h3 class="text-center"><?php echo e(__('NO FDR PLAN FOUND')); ?></h3>
              </div>
            <?php else: ?>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"><?php echo e(('Apply for FDR')); ?></h5>
        ...
        <form action="<?php echo e(route('user.fdr.amount')); ?>" method="post">
            ...
            <div class="modal-body">
              <div class="form-group">
                ...
                <input name="amount" id="amount" class="form-control" autocomplete="off" placeholder="<?php echo e(__('0.0')); ?>" type="number" step="any" min="0" value="<?php echo e(old('amount')); ?>" required>
              </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/royalscripts/public_html/test/geniusbank/project/resources/views/user/fdr/plan.blade.php ENDPATH**/ ?>