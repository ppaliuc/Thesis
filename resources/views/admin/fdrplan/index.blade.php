...
<div class="card">
	...
	<h5 class=" mb-0 text-gray-800 pl-3">{{ __('Fdr Plan') }}</h5>
	<ol class="breadcrumb">
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
           ...
           serverSide: true,
           searching: true,
           ajax: '{{ route('admin.fdr.plan.datatables') }}',
           columns: [
        ...
        $(".btn-area").append('<div class="col-sm-12 col-md-4 pr-3 text-right">'+
            '<a class="btn btn-primary" href="{{route('admin.fdr.plan.create')}}">'+
