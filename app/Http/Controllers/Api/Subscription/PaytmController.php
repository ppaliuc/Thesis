...
class PaytmController extends Controller
{
    ...
    public function store(Request $request){
        ...
        {
            $data['get'] = json_encode(['status' => false, 'data' => "Please Select INR Currency For Paytm", 'error' => []]);
    ...
    public function handlePaytmRequest( $transaction_id, $amount) {
        ...
        $paramList["CALLBACK_URL"] = route('api.subscription.paytm.notify');
    ...
    public function paytmCallback( Request $request ) {
        ...
        if ( 'TXN_SUCCESS' === $request['STATUS'] ) {
            ...
            $data['get'] = json_encode(['status' => false, 'data' => "Payment Cancelled.", 'error' => []]);
            return view('frontend.api_payment',$data);
        }
    }
}
