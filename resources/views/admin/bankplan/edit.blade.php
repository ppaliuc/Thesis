          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="amount" name="amount" placeholder="{{ __('Enter Amount (USD)') }}" min="0" value="{{ $data->amount }}" required>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="daily_send" name="daily_send" placeholder="{{ __('ex.1000 USD') }}" min="0" value="{{ $data->daily_send }}" required>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="monthly_send" name="monthly_send" placeholder="{{ __('ex.10000 USD') }}" min="0" value="{{ $data->monthly_send }}" required>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="daily_receive" name="daily_receive" placeholder="{{ __('ex.1000 USD') }}" min="0" value="{{ $data->daily_receive }}" required>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="monthly_receive" name="monthly_receive" placeholder="{{ __('ex.10000 USD') }}" min="0" value="{{ $data->monthly_receive }}" required>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="daily_withdraw" name="daily_withdraw" placeholder="{{ __('ex.1000 USD') }}" min="0" value="{{ $data->daily_withdraw }}" required>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="monthly_withdraw" name="monthly_withdraw" placeholder="{{ __('ex.10000 USD') }}" min="0" value="{{ $data->monthly_withdraw }}" required>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="loan_amount" name="loan_amount" placeholder="{{ __('Loan Amount (USD)') }}" min="1" value="{{ $data->loan_amount }}" required>
              </div>
            </div>
          </div>
