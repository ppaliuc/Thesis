...
<div class="card">
	...
	<ol class="breadcrumb m-0 py-0">
		...
		<li class="breadcrumb-item"><a href="{{ route('admin.wire.transfer.index') }}">{{ __('Wire Transfer') }}</a></li>
	</ol>
	</div>
</div>
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
           ...
           serverSide: true,
           searching: true,
           ajax: '{{ route('admin.wire.transfer.datatables') }}',
           columns: [
				{ data: 'transaction_no', name: 'transaction_no' },
				{ data: 'wire_transfer_bank_id', name: 'wire_transfer_bank_id' },
